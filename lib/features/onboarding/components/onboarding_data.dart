...
class OnboardingData{
  ...
  List<OnboardingInfo> items = [
    ...
    OnboardingInfo(
        text: "A dynamic platform designed to connect startups with aspiring investors.",
        image:Assets.imagesOnboardingTwo),

    OnboardingInfo(
        text: "Showcase ongoing or high-performing projects with thumbnails, brief summaries, and funding Progress Bars.",
